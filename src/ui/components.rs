...
impl ColorTheme {
    ...
    pub fn everforest() -> Self {
        Self {
            bg:           hex(0x23, 0x2a, 0x2e),
            bg1:          hex(0x2d, 0x35, 0x3b),
            bg2:          hex(0x34, 0x3f, 0x44),
            bg3:          hex(0x3d, 0x48, 0x4d),
            fg:           hex(0xd3, 0xc6, 0xaa),
            fg_dim:       hex(0x85, 0x92, 0x89),
            border:       hex(0x47, 0x52, 0x58),
    ...
    pub fn onedark() -> Self {
        Self {
            bg:           hex(0x18, 0x1a, 0x1f),
            bg1:          hex(0x28, 0x2c, 0x34),
            bg2:          hex(0x31, 0x35, 0x3f),
            bg3:          hex(0x39, 0x3f, 0x4a),
            fg:           hex(0xab, 0xb2, 0xbf),
            fg_dim:       hex(0x5c, 0x63, 0x70),
            border:       hex(0x3b, 0x3f, 0x4c),
            border_focus: hex(0x61, 0xaf, 0xef),
            accent:       hex(0x56, 0xb6, 0xc2),
            red:          hex(0xe8, 0x66, 0x71),
            orange:       hex(0xd1, 0x9a, 0x66),
            yellow:       hex(0xe5, 0xc0, 0x7b),
            green:        hex(0x98, 0xc3, 0x79),
            blue:         hex(0x61, 0xaf, 0xef),
            cyan:         hex(0x56, 0xb6, 0xc2),
            purple:       hex(0xc6, 0x78, 0xdd),
        }
    }
}

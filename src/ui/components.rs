...
impl ColorTheme {
    ...
    pub fn gruvbox_material() -> Self {
        Self {
            bg: hex(0x1b, 0x1b, 0x1b),
            bg1: hex(0x28, 0x28, 0x28),
            bg2: hex(0x32, 0x30, 0x2f),
            bg3: hex(0x45, 0x40, 0x3d),
            fg: hex(0xd4, 0xbe, 0x98),
            fg_dim: hex(0x92, 0x83, 0x74),
            border: hex(0x5a, 0x52, 0x4c),
    ...
    pub fn nord() -> Self {
        Self {
            bg: hex(0x18, 0x1c, 0x24),
            bg1: hex(0x2e, 0x34, 0x40),
            bg2: hex(0x3b, 0x42, 0x52),
            bg3: hex(0x43, 0x4c, 0x5e),
            fg: hex(0xd8, 0xde, 0xe9),
            fg_dim: hex(0x61, 0x6e, 0x88),
            border: hex(0x3b, 0x42, 0x52),
    ...
    pub fn onedark() -> Self {
        Self {
            bg: hex(0x1f, 0x23, 0x29),
            bg1: hex(0x28, 0x2c, 0x34),
            bg2: hex(0x30, 0x36, 0x3f),
            bg3: hex(0x32, 0x36, 0x41),
            fg: hex(0xa0, 0xa8, 0xb7),
            fg_dim: hex(0x53, 0x59, 0x65),
            border: hex(0x32, 0x36, 0x41),
            border_focus: hex(0x4f, 0xa6, 0xed),
            accent: hex(0x48, 0xb0, 0xbd),
            red: hex(0xe5, 0x55, 0x61),
            orange: hex(0xcc, 0x90, 0x57),
            yellow: hex(0xe2, 0xb8, 0x6b),
            green: hex(0x8e, 0xbd, 0x6b),
            blue: hex(0x4f, 0xa6, 0xed),
            cyan: hex(0x48, 0xb0, 0xbd),
            purple: hex(0xbf, 0x68, 0xd9),
        }
    }
}
